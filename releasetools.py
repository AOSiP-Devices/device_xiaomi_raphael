...
def AddVendorAssertion(info, input_zip):
  ...
  cmd = 'assert(getprop("ro.boot.hwc") == "{0}" && (raphael.verify_vendor("{2}", "{1}") == "1" || abort("ERROR: This package requires vendor from atleast {2}. Please upgrade firmware and retry!");));' 
